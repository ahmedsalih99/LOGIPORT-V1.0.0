...
class AddPackagingTypeDialog(BaseDialog):
    def __init__(self, parent=None, packaging_type=None):
        super().__init__(parent)
        self.packaging_type = packaging_type
        self.setWindowTitle(self._("add_packaging_type") if packaging_type is None else self._("edit_packaging_type"))
        self.init_ui()
    ...
    def init_ui(self):
        ...
        if self.packaging_type:
            self.name_ar.setText(self.packaging_type.get("name_ar", ""))
            self.name_en.setText(self.packaging_type.get("name_en", ""))
            self.name_tr.setText(self.packaging_type.get("name_tr", ""))
